 ...
 */
mindhub.AutoSaveController = function(eventBus, mindmapModel) {
	...
	this.init = function() {
		eventBus.subscribe(mindhub.Event.DOCUMENT_OPENED, this.documentOpened
			.bind(this));

		eventBus.subscribe(mindhub.Event.DOCUMENT_CLOSED, this.documentClosed
			.bind(this));
	};
