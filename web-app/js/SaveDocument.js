...
* @constructor
*/
mindhub.SaveDocumentView = function() {
  var self = this;
...
*/
mindhub.SaveDocumentPresenter = function(eventBus, mindmapModel, view, autosaveController, filePicker) {
...
//    });
    ...
    jQuery.post("http://localhost:8080/Mindhub/main/save",
//    	JSON.parse(json),
//    	JSON.stringify(json),
    	json,
    	function(data){
